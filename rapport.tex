...
\subsection{Hypothèses évaluées}

\begin{center}
\begin{tabular}{clcc}
\toprule
\textbf{ID} & \textbf{Hypothèse} & \textbf{Seuil} & \textbf{Statut} \\
\midrule
H1 & Pearson $r \geq 0{,}60$ entre Score\_Global et gold standard
   & $r \geq 0{,}60$ & \textcolor{green!60!black}{\textbf{Validée}} \\
H2 & $\Delta$Pearson (multi-agents vs LLM unique) $> 0{,}10$
   & $\Delta > 0{,}10$ & \textcolor{green!60!black}{\textbf{Validée}} \\
H3 & Taux de fallback heuristique $< 5\%$
   & $< 5\%$           & \textcolor{green!60!black}{\textbf{Validée}} \\
H4 & Gain F1 CoT/ToT vs prompt direct $\geq 15$ pts
   & $\geq 15$ pts     & \textcolor{green!60!black}{\textbf{Validée}} \\
\bottomrule
\end{tabular}
\end{center}
