...
Génère notebooks/phase5_evaluation.ipynb à partir de zéro.
...
cells_raw = [
    ...
    md("## 1. Chargement des résultats JSON"),
    code(
    ...
    md("## 2. H1 — Corrélation Pearson (Score_Global vs gold_score)"),
    code(
        "if metrics:\n",
    ...
    md("## 4. H3 — Étude d'ablation (contribution par agent)"),
    code(
        "if ablation:\n",
    ...
    md("## 5. Métriques sentiment et bruit"),
    code(
        "if metrics:\n",
    ...
    md("## 6. Analyse des outliers de score"),
    code(
        "if errors:\n",
